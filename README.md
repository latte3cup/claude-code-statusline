...
```
Opus 4.7 (Mid) │ main★ │ /my-project │ 5% context │ 53% session ↻ 06:00 PM │ 4% weekly ↻ 06-16(화) 03:00
```
...
| Session quota + reset time | `53% session ↻ 06:00 PM` |
| Weekly quota + reset date/time | `4% weekly ↻ 06-16(화) 03:00` |
